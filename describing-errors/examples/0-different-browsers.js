...
/* Different Browsers
  ...
  when all goes well, the main browsers will interpret your code (mostly) the same way (chrome/ium, firefox, edge)
  ...
  if you are using a different browser and get a slightly different message or line number
    it can still be correct!

  when describing your errors (for yourself, a classmate, a coach, on stackoverflow, ... )
    you should mention which browser you were using.
