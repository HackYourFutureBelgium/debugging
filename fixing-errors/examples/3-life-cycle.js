...
/* Life Cycle
  ...
  take a minute to read through Program Life-Cycle in the /describing-errors README if you haven't yet
    ...
  done?  good, moving on.
  ...
  3. look at the first line of your callstack, does it look like ...
    <anonymous>:x:y   -> execution
    <anonymous>       -> creation
  4. in firefox: does the `debugger eval code:x:y` link work?
